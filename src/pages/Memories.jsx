      ...
      >
        ...
        >
          ...
          <div className="text-left text-pink-800 space-y-4 leading-relaxed">
            ...
            >
              If I can't be the best, sorry if from the beginning we met until
              now there are things that make you uncomfortable 💔. And sorry if
              I often get angry 😞, often order things around 😔, often sulk 😢,
              often get angry for no reason 🥺, selfish 😓 and sometimes like to
              find small problems... but from all that, I definitely want you to
              be the best 💗.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              I hope you don't forget me 🌸 and always serve me like the first
              time we met 💕.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              Thank you especially to your mother 🙏🏻🤍 who has served and
              treated me and my family very well, and thank you also to your
              family 💗✨
            </motion.p>
          </div>
        </motion.div>
